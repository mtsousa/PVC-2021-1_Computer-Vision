...
class CocoDataset(utils.Dataset):
    def load_coco(self, img_dataset_dir, inst_dataset, subset,
        ...
        #     self.auto_download(img_dataset_dir, subset, year)

        coco = COCO("{}/annotations/instances_{}2017.json".format(inst_dataset, subset))
        if subset == "minival" or subset == "valminusminival":
            subset = "val"
        # image_dir = "{}/{}{}".format(img_dataset, subset, year)
...
if __name__ == '__main__':
    ...
    # Load weights and exlcude some layers
...
####### *** This training schedule is an example. Update to your needs *** #########
    ...
    ## Save the CNN configurations
    save = input('Save the CNN configurations? (y/n)')
    if save == 'y':
        pass